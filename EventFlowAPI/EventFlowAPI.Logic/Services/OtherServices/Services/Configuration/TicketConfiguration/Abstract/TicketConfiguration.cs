...
namespace EventFlowAPI.Logic.Services.OtherServices.Services.Configuration.TicketConfiguration.Abstract
{
        ...
        IAssetService assetService) : ITicketConfiguration<TEntity> where TEntity : class
    {
        ...
        public DatePrintingOptions GetDatePrintingOptions()
        {
            return new DatePrintingOptions
            {
                Font = DateFont,
        ...
        public QRCodePrintingOptions GetQRCodePrintingOptions()
        {
            return new QRCodePrintingOptions
            {
