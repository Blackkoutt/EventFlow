...
namespace EventFlowAPI.Logic.Services.OtherServices.Services.TicketConfiguration
{
        ...
        IFestivalTicketConfiguration
    {
        ...
        public TicketPrintingOptions GetTabNumberPrintingOptions()
        {
        ...
        public TicketPrintingOptions GetEventInfoPrintingOpitons()
        {
        ...
        public TicketPrintingOptions GetSeatsPrintingOpitons()
        {
