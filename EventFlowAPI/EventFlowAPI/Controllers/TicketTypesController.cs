...
namespace EventFlowAPI.Controllers
{
    ...
    public class TicketTypesController(ITicketTypeService ticketTypeService) : ControllerBase
    {
        ...
        {
            var result = await _ticketTypeService.AddAsync(additionalServicesReqestDto);
        ...
        {
            var result = await _ticketTypeService.UpdateAsync(id, additionalServicesReqestDto);
